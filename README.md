# meta-qcom-robotics-releases

This repository holds the kas lock files for meta-qcom-robotics-sdk milestone releases.
...
1. Download Qualcomm Yocto and the supporting meta-layers.
    ...
    ```bash
    git clone https://github.com/qualcomm-linux/meta-qcom-robotics-releases.git -b <releases-tag>
    kas checkout meta-qcom-robotics-releases/lock.yml
    ```

2. Copy the kas lock file from meta-qcom-robotics-releases to meta-qcom-robotics-sdk. Make sure to
...
newer commit.
    ...
    # copy kas lock file to meta-qcom-robotics-sdk repository
...
combinations.
    ...
    ```bash
    kas build meta-qcom-robotics-sdk/ci/<machine.yml>:meta-qcom-robotics-sdk/ci/<distro.yml>:meta-qcom-robotics-sdk/ci/lock.yml
    ```
...
technical questions related to this repository.
  👉 [Open an Issue](https://github.com/qualcomm-linux/meta-qcom-robotics-sdk/issues)
